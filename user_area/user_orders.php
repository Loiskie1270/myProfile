...
//echo $user_id;
?>
<h3 class="text-bg-success mt-4 mb-0">My Orders</h3>
<table class="table table-bordered mt-0 mb-5">
    <thead class="bg-info">
    <tr>
...
while($row_orders=mysqli_fetch_assoc($result_orders)){
   ...
   if($order_status=='Complete'){
    echo "<td class='bg-secondary text-light'><strong>Paid</strong></td>";
   }else{
    echo "<td class='bg-secondary text-light'><a href='confirm_payment.php?order_id=$order_id'><strong text-light>Confirm</strong></a></td>
    </tr>";   
   }
$number++;        
}
