 ...
 if(isset($_GET['edit_account'])){
    ...
    if(isset($_POST['user_update'])){
        ...
        $user_image_tmp=$_FILES['user_image']['TMP.NAME'];
        move_uploaded_file($user_image_tmp,"./user_images/$user_image");

       // UPDATE FIELDS IN YOUR DATABASE `user_table`
        ...
        $result_query_upate=mysqli_query($conn,$update_data);
        if( $result_query_upate){
