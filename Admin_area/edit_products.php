...
<div class="container mt-4">
    <h3 class="text-center text-light">EDIT PRODUCT</h3>
...
?>  
        ...
        <div class="form_outline w-50 m-auto mb-4">
            ...
            <img src="./product_images/<?php echo $product_image1 ?>" alt="" class="product1_img">
            </div>
        </div>
        <div class="form_outline w-50 m-auto mb-4">
            ...
            <img src="./product_images/<?php echo $product_image2 ?>" alt="" class="product1_img">
            </div>
        </div>
        <div class="form_outline w-50 m-auto mb-4">
            ...
            <img src="./product_images/<?php echo $product_image3 ?>" alt="" class="product1_img">
            </div>
        </div>
        <div class="form_outline w-50 m-auto mb-4">
        ...
        <input type="submit" name="edit_product" value="Update Product" class="btn btn-info px-3 mb-3 border-0">
        </div>
    </form>
</div>
